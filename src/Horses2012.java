...
public class Horses2012 {
	...
	public void testSetUpSpaces() throws Exception {
		...
		horseBarn.addHorse(new Horse("Trigger", 1340));
		horseBarn.addHorse(new Horse("GARGAR", 0));
		horseBarn.addHorse(new Horse("Silver", 1210));
		horseBarn.addHorse(new Horse("Lady", 1575));
		horseBarn.addHorse(new Horse("GARGAR", 0));
		horseBarn.addHorse(new Horse("Patches", 1350));
		horseBarn.addHorse(new Horse("Duke", 1410));
